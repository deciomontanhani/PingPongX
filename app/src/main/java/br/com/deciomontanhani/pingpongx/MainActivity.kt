...
class MainActivity : AppCompatActivity() {
    ...
    private fun registerObserver() {
        mainViewModel.playerOneScore.observe(this, Observer { score ->
            tvPlayerOneScore.text = score.toString()
        })

        mainViewModel.playerTwoScore.observe(this, Observer { score ->
            tvPlayerTwoScore.text = score.toString()
        })
    }
